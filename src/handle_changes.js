...
type Config = {SESSION_DIR : string, MAX_CLONE_DURATION_MS : number}

module.exports = function makeHandleChanges(config : Config, store, actions) {
    const {SESSION_DIR, MAX_CLONE_DURATION_MS} = config
    console.log('MAX_CLONE_DURATION_MS', MAX_CLONE_DURATION_MS)
